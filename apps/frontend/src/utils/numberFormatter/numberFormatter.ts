import { formatPercent, formatUsd, normalizeDecimalPrecision, numFormatter } from './number-utils'
...
export const numberFormatter = {
  ...
  /**
   * Will return the value with the decimal precision.
   * Returns the number with CURRENCY_PRECISION configured on the application
   * Example: 9999.99
   * @memberof numberFormatter
   ...
   * @param value - The value that will be formatted.
   */
  withPrecision: (value: number | string | undefined): string => normalizeDecimalPrecision(value),
}
