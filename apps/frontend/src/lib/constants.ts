...
export const NETWORKS: Networks = {
  ...
  mainnet: {
    ...
    color: '#ff8b9e',
    chainId: 1,
    rpcUrls: [`https://mainnet.infura.io/v3/${config.MAINNET_INFURA_KEY}`],
  ...
  kovan: {
    ...
    color: '#7003DD',
    chainId: 42,
    rpcUrls: [`https://kovan.infura.io/v3/${config.KOVAN_INFURA_KEY}`],
  ...
  rinkeby: {
    ...
    color: '#e0d068',
    chainId: 4,
    rpcUrls: [`https://rinkeby.infura.io/v3/${config.RINKEBY_INFURA_KEY}`],
  ...
  ropsten: {
    ...
    rpcUrls: [`https://ropsten.infura.io/v3/${config.ROPSTEN_INFURA_KEY}`],
  },
  goerli: {
    name: 'goerli',
    color: '#0975F6',
